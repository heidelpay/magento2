...
use Heidelpay\Gateway\Gateway\Config\HgwInvoicePaymentConfigInterface;
...
class HeidelpayInvoicePaymentMethod extends HeidelpayAbstractPaymentMethod
{
     ...
     * @param HgwInvoicePaymentConfigInterface $paymentConfig
    ...
    public function __construct(
        ...
        HgwInvoicePaymentConfigInterface $paymentConfig,
